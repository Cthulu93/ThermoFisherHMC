# Django settings for hackathon_web project.
...
SECRET_KEY = 'wgi6x*&amp;og=t5(6z711u_d@js=gt^*jssoz)_7gl19zpq^*%!9l'
...
ROOT_URLCONF = 'hackathon_web.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'hackathon_web.wsgi.application'
